...
// DepositHoldings is a paid mutator transaction binding the contract method 0xc01199f4.
//
// Solidity: function depositHoldings(address u, uint256 m, uint256 a) returns()
func (_Redeemer *RedeemerTransactor) DepositHoldings(opts *bind.TransactOpts, u common.Address, m *big.Int, a *big.Int) (*types.Transaction, error) {
	return _Redeemer.contract.Transact(opts, "depositHoldings", u, m, a)
}

// DepositHoldings is a paid mutator transaction binding the contract method 0xc01199f4.
//
// Solidity: function depositHoldings(address u, uint256 m, uint256 a) returns()
func (_Redeemer *RedeemerSession) DepositHoldings(u common.Address, m *big.Int, a *big.Int) (*types.Transaction, error) {
	return _Redeemer.Contract.DepositHoldings(&_Redeemer.TransactOpts, u, m, a)
}

// DepositHoldings is a paid mutator transaction binding the contract method 0xc01199f4.
//
// Solidity: function depositHoldings(address u, uint256 m, uint256 a) returns()
func (_Redeemer *RedeemerTransactorSession) DepositHoldings(u common.Address, m *big.Int, a *big.Int) (*types.Transaction, error) {
	return _Redeemer.Contract.DepositHoldings(&_Redeemer.TransactOpts, u, m, a)
}
